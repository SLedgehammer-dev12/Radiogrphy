...
title = RT Radiography

# (str) Package name
package.name = radiography

# (str) Package domain (needed for android/ios packaging)
package.domain = com.radiography
...
source.exclude_dirs = tests, bin, venv, __pycache__, .git, src/ui
...
requirements = python3,kivy==2.3.1,kivymd==1.1.1,reportlab
